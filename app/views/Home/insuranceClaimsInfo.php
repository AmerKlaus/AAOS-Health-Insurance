...
<body>
    ...
    <section id="knowledge-base">
        <div class="container">
            ...
            <p><?php echo __("Welcome to our knowledge base! Here, you can find detailed information related to insurance claims."); ?>
            </p>
            ...
            <ul>
                <li><strong><?php echo __("Understanding the Insurance Claims Process:"); ?></strong>
                    <?php echo __("Learn about the steps involved in filing an insurance claim and what to expect."); ?>
                </li>
                <li><strong><?php echo __("Tips for Filing Insurance Claims:"); ?></strong>
                    <?php echo __("Discover useful tips and strategies to ensure a smooth and successful insurance claim process."); ?>
                </li>
                <li><strong><?php echo __("Common Mistakes to Avoid in Insurance Claims:"); ?></strong>
                    <?php echo __("Avoid pitfalls and mistakes that could jeopardize your insurance claim."); ?></li>
            </ul>

            <h3><?php echo __("Resources:"); ?></h3>
            <p><?php echo __("Check out these resources for more information:"); ?></p>
            <ul>
                <li><strong><?php echo __("Sample Claim Forms:"); ?></strong>
                    <?php echo __("Download sample claim forms to help you fill out your insurance claim accurately."); ?>
                </li>
                <li><strong><?php echo __("Guide to Insurance Claim Documentation:"); ?></strong>
                    <?php echo __("Understand the documentation requirements for different types of insurance claims."); ?>
                </li>
                <li><strong><?php echo __("FAQs on Insurance Claims:"); ?></strong>
                    <?php echo __("Find answers to frequently asked questions about insurance claims."); ?></li>
            </ul>
        </div>
    </section>
